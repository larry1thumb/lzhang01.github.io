public class ScatterPlot {
    ...
    color mark_positions(int i) {
        color ret = #ff0000;
        if (positions[i].equals("PG")) {
            ret = color(191, 24, 24);
        } else if (positions[i].equals("SG")) {
            ret = color(31, 164, 44);
        } else if (positions[i].equals("SF")) {
            ret = color(31, 164, 44);
        } else if (positions[i].equals("PF")) {
            ret = color(31, 164, 44);
        } else if (positions[i].equals("C")) {
            ret = color(117, 60, 191);
        } else {
        }
        return ret;
    }
